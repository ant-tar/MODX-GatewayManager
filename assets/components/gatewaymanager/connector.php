...
$namespace = $modx->getObject('modNamespace', 'gatewaymanager');
$corePath = $namespace->get('path');
require_once $corePath.'model/gatewaymanager/gatewaymanager.class.php';
...
/* handle request */
$path = $modx->getOption($cp, $modx->gatewaymanager->config, $corePath.'processors/');
